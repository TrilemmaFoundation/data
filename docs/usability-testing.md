...
- Do not create accounts. Shortlists stay in the browser.
...
4. **Compare alternatives.** Prompt: “Shortlist two or three options and decide which you would actually start with.”
...
- Task 4 produces a shareable compare URL or an explicit shortlist decision
