...
export function SiteFooter() {
  return <>
    <aside aria-label="About the catalog" className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-8 text-sm text-muted-foreground sm:px-6">
